package tech.kayys.gamelan.model.event;
...
/**
 * Simple verification that GenericExecutionEvent is properly permitted by
 * ExecutionEvent
 */
public class ExecutionEventVerification {
    public static void main(String[] args) {
        ...
        // This should compile without issues if GenericExecutionEvent is properly
        // permitted
