...
public class WaitInfo {
    ...
    public Instant getWaitStartedAt() {
    ...
    public Map<String, Object> getWaitData() {
        return waitData;
    }
    ...
    public static WaitInfo humanApproval(String nodeId, String approvalRequestId, String approver) {
        return builder().waitType(WaitType.HUMAN_APPROVAL).nodeId(nodeId).reason("Waiting for human approval")
                ...
                .waitData(Map.of("approvalRequestId", approvalRequestId, "approver", approver, "requiredAction",
                        "approve_or_reject"))
    ...
    public static WaitInfo externalCallback(String nodeId, String callbackUrl, String expectedResponse) {
        return builder().waitType(WaitType.EXTERNAL_CALLBACK).nodeId(nodeId)
    ...
    public static WaitInfo timer(String nodeId, Duration duration, String timerName) {
        return builder().waitType(WaitType.TIMER).nodeId(nodeId).reason("Waiting for timer: " + timerName)
                ...
                .waitData(Map.of("duration", duration.toMillis(), "timerName", timerName, "expiresAt",
                        Instant.now().plus(duration).toString()))
    ...
    public static WaitInfo condition(String nodeId, String conditionExpression) {
        return builder().waitType(WaitType.CONDITION).nodeId(nodeId)
    ...
    public boolean isHumanInvolved() {
        return waitType == WaitType.HUMAN_APPROVAL || waitType == WaitType.MANUAL_INTERVENTION;
    }
    ...
    public static class Builder {
        ...
        public Builder waitStartedAt(Instant waitStartedAt) {
        ...
        public Builder waitData(Map<String, Object> waitData) {
