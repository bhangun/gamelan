package tech.kayys.gamelan.engine.run.dto;
...
public record RetryPolicyDto(
        @Min(1) @Max(10) @Schema(description = "Max attempts", minimum = "1", maximum = "10") int maxAttempts,

        @Min(0) @Schema(description = "Initial delay in seconds") long initialDelaySeconds,

        @Min(0) @Schema(description = "Max delay in seconds") long maxDelaySeconds,
