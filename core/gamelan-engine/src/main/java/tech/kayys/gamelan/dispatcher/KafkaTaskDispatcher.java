...
import tech.kayys.gamelan.scheduler.TaskMessage;
...
public class KafkaTaskDispatcher implements TaskDispatcher {
    ...
    void initMetrics() {
        this.successCounter = Counter.builder("gamelan.dispatcher.kafka.success")
                .description("Number of successful Kafka dispatches")
                .register(meterRegistry);
        this.failureCounter = Counter.builder("gamelan.dispatcher.kafka.failure")
                .description("Number of failed Kafka dispatches")
                .register(meterRegistry);
        this.dispatchTimer = Timer.builder("gamelan.dispatcher.kafka.duration")
