...
public class DefaultWorkflowRunManager implements tech.kayys.gamelan.engine.workflow.WorkflowRunManager {
                ...
                return definitionRegistry.getDefinition(new WorkflowDefinitionId(request.getWorkflowId()), tenantId)
                                .flatMap(definition -> {
                                        ...
                                        return runRepository.persist(run)
                                                        .flatMap(persistedRun -> historyRepository.appendEvents(
                                                                        persistedRun.getId(),
                ...
                return runRepository.withLock(runId, run -> {
                        ...
                        return runRepository.update(run)
                                        ...
                                        .invoke(() -> {
                                                ...
                                                LOG.error("DefaultWorkflowRunManager SEVERE LOG: Event published for {}",
                                                                runId.value());
                                        });
                });
        }
                ...
                return runRepository.withLock(runId, run -> {
                        ...
                        return runRepository.update(run)
                                        .call(() -> historyRepository.append(
                                                        ...
                                                        Map.of("reason", reason, "waitingOnNode",
                                                                        waitingOnNodeId.value())));
                });
        }
                                                ...
                                                return historyRepository.append(
                                                                ...
                                                                .chain(() -> {
                                                                        ...
                                                                        if (result
                                                                                ...
                                                                                run.completeNode(result.nodeId(),
                                                                                                result.attempt(),
                                                                                                result.output() != null
                                                                                                                ? result.output()
                                                                                                                : Map.of());
                                                                                return runRepository.update(run)
                                                                                                .invoke(() -> eventBus
                                                                                                                .publish("gamelan.runs.v1.updated",
                                                                                                                                runId.value()))
                                                                                                .replaceWithVoid();
                                                                        } else {
                                                                                run.failNode(result.nodeId(),
                                                                                                result.attempt(),
                                                                                                result.error());
                                                                                return runRepository.update(run)
                                                                                                .invoke(() -> eventBus
        ...
        public Uni<Void> onExternalSignal(
                ...
                return callbackService.verify(callbackToken)
                                .flatMap(valid -> valid
                                                ? signal(runId,
                                                                new Signal(signal.getSignalType(),
