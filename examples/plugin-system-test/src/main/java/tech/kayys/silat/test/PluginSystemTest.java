...
import tech.kayys.silat.plugin.impl.DefaultPluginService;
...
public class PluginSystemTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Silat Plugin System Test");
        System.out.println("=".repeat(80));
        System.out.println();
        ...
        try {
            ...
            Path pluginJar = Paths.get("../examples/silat-plugin-example/target/silat-plugin-example-1.0.0-SNAPSHOT.jar");
            if (!pluginJar.toFile().exists()) {
                ...
                System.err.println("  mvn clean package -f examples/silat-plugin-example/pom.xml");
                System.exit(1);
            }
            ...
            System.out.println();
            System.out.println("The Silat Plugin System is working correctly!");
