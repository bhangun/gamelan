...
public class EdgeDefinition {
    ...
    public void setFrom(String from) {
        if (from == null || from.trim().isEmpty()) {
            throw new GamelanException(ErrorCode.MISSING_REQUIRED_FIELD, "Edge source cannot be empty");
        }
        this.from = from;
    }
    ...
    public void setTo(String to) {
        if (to == null || to.trim().isEmpty()) {
            throw new GamelanException(ErrorCode.MISSING_REQUIRED_FIELD, "Edge target cannot be empty");
        }
        this.to = to;
    }
    ...
    public void setFromPort(String fromPort) {
        if (fromPort == null || fromPort.trim().isEmpty()) {
            throw new GamelanException(ErrorCode.MISSING_REQUIRED_FIELD, "Source port cannot be empty");
        }
        this.fromPort = fromPort;
    }
    ...
    public void setToPort(String toPort) {
        if (toPort == null || toPort.trim().isEmpty()) {
            throw new GamelanException(ErrorCode.MISSING_REQUIRED_FIELD, "Target port cannot be empty");
        }
        this.toPort = toPort;
    }
