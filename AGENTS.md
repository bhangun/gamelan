...
The Wayang Workflow Engine is responsible for parsing, scheduling, and executing complex workflows. It implements sophisticated  types to manage workflow orchestration, task coordination, and execution monitoring.
